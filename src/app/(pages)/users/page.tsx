...
const TableHead = ({ handleSorting }: Props) => {
...
const Users = () => {
  ...
  if (data && !data.length) {
    return (
      <>
        <h1 className='head_text blue_gradient mt-0 md:mt-2 text-center'>Список возвещателей</h1>
        {loading ? <Spinner wrapper /> : <div className='text-center mt-10'>Список пуст</div>}
      </>
    )
  }
